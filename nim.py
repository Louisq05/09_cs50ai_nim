...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        q_value = self.q.get((tuple(state), action))        # Get Q value as a tuple
        return q_value if q_value else 0                    # Return it
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        """
        new_q_value = old_q + self.alpha * ((reward + future_rewards)-old_q)    # q value calculation from the formula
        self.q[tuple(state), action] = new_q_value                              # q value update 
    ...
    def choose_action(self, state, epsilon=True):
        ...
        best_action = None              # Declare best action
        best_action_value = None        # Declare best action q value
